		...
		<div class="row">
			...
			<div class="col-12 col-lg-8 colIzqHabitaciones p-0">
				...
				<div class="pt-4 cabeceraHabitacion">
					...
					<h2 class="float-right text-white px-3 categoria text-uppercase"><?php echo $salas[0]["tipo"]; ?>
					</h2>
				...
				<section class="mb-3 my-lg-3 videoHabitaciones d-none">
					...
					<iframe width="100%" height="380"
						src="https://www.youtube.com/embed/<?php echo $salas[0]["video"]; ?>" frameborder="0"
				...
				<section class="mb-3 my-lg-3 360Habitaciones d-none">
					...
					<div id="myPano" class="pano" back="<?php echo $servidor . $salas[0]["recorrido_virtual"]; ?>">
				...
				<div class="descripcionHabitacion px-3">
					...
					<h1 class="colorTitulos float-left text-uppercase">
						<?php echo $salas[0]["estilo"] . " " . $salas[0]["tipo"]; ?>
					</h1>
										...
										<a href="<?php echo $ruta . $value["ruta"]; ?>">
											...
											<figure class="text-center">
												...
												<h3 class="py-2 text-gray-dark mb-0">DESDE
													$<?php echo $value["temporada_descuento"]; ?> MXN
												</h3>
												...
												<h1 class="text-white p-3 mx-auto w-50 lead text-uppercase"
													style="background:<?php echo $value["color"]; ?>">
													<?php echo $value["tipo"]; ?>
												</h1>
											</figure>
										</a>
